...
// COMPETITIONS
// ------------------------------------------------------
// Competition-specific permissions are handled inside
// routes/competitions.js. Let all authenticated users
// reach that router so it can apply the correct role rules.
// ======================================================
if (
